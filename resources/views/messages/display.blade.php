            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-4" style="text-align: right; display: -webkit-inline-box; margin-right:0;">
                            <a href="{{ route("slacker.dashboard") }}" class="btn btn-danger btn-sm mr-2" style="color: white;">Back</a>
                            <div class="dropdown">
                                <a href="#" class="dropdown-toggle btn btn-sm btn-danger mr-2" data-toggle="dropdown">Operations</a>
                                <div class="dropdown-menu">
                                    <a href="{{ route("slacker.channel.webhook.create", ['channel' => $channel]) }}" class="dropdown-item">Clear</a>
                                </div>
                            </div>
                            <div class="dropdown">
